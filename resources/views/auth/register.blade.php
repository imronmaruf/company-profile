                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-flat">
                            ...
                            <span class="input-group-text">
                                <a href="javascript:void(0)" class="toggle-password link-secondary" title="Show password"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-flat">
                            ...
                            <span class="input-group-text">
                                <a href="javascript:void(0)" class="toggle-password-confirmation link-secondary"
                                    title="Show password"
                                    data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggleVisibility('.toggle-password-confirmation', 'password-confirm', eyeIcon, eyeOffIcon);
        });
    </script>
@endpush
