...
<div class="modal modal-blur fade" id="modalAdd" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{ route('be/testimonials.store') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label class="form-label">Asal Instansi/Posisi</label>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="testimonial" name="testimonial" class="form-control @error('testimonial') is-invalid @enderror"
    ...
    <div class="modal modal-blur fade" id="modalEdit{{ $data->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('be/testimonials.update', $data->id) }}" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label class="form-label">Testimoni</label>
                                    <textarea name="testimonial" class="form-control @error('testimonial') is-invalid @enderror" rows="4" required>{{ old('testimonial', $data->testimonial) }}</textarea>
                                    @error('testimonial')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
