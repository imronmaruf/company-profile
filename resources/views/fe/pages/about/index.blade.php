            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="person">
                            <figure>
                                <img src="{{ asset('fe/assets/img/team/team-2.jpg') }}" alt="Image" class="img-fluid">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="person">
                            <figure>
                                <img src="{{ asset('fe/assets/img/team/team-3.jpg') }}" alt="Image" class="img-fluid">
                                <div class="social">
                                    <a href="#"><span class="bi bi-facebook"></span></a>
                                    <a href="#"><span class="bi bi-twitter-x"></span></a>
                                    <a href="#"><span class="bi bi-linkedin"></span></a>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="person">
                            <figure>
                                <img src="{{ asset('fe/assets/img/team/team-4.jpg') }}" alt="Image" class="img-fluid">
                                <div class="social">
                                    <a href="#"><span class="bi bi-facebook"></span></a>
                                    <a href="#"><span class="bi bi-twitter-x"></span></a>
                                    <a href="#"><span class="bi bi-linkedin"></span></a>
