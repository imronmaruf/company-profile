            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <article class="position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="{{ asset('fe/assets/img/blog/blog-3.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="meta d-flex align-items-end">
                ...
                <div class="col-lg-4">
                    <article class="position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="{{ asset('fe/assets/img/blog/blog-4.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="meta d-flex align-items-end">
                ...
                <div class="col-lg-4">
                    <article class="position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="{{ asset('fe/assets/img/blog/blog-5.jpg') }}" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <article class="position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="{{ asset('fe/assets/img/blog/blog-6.jpg') }}" class="img-fluid" alt="">
                        </div>
