    ...
    <section id="hero" class="hero section dark-background">
        <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item active">
                <img src="{{ asset('fe/assets/img/hero_1.jpg') }}" alt="">
            ...
            <div class="carousel-item">
                <img src="{{ asset('fe/assets/img/hero_2.jpg') }}" alt="">
                <div class="carousel-container">
            ...
            <div class="carousel-item">
                <img src="{{ asset('fe/assets/img/hero_3.jpg') }}" alt="">
                <div class="carousel-container">
            ...
            <div class="carousel-item">
                <img src="{{ asset('fe/assets/img/hero_4.jpg') }}" alt="">
                <div class="carousel-container">
            ...
            <div class="carousel-item">
                <img src="{{ asset('fe/assets/img/hero_5.jpg') }}" alt="">
                <div class="carousel-container">
